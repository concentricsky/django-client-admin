...
class MenuItem(object):
    ...
    ``template``
        ...
        Default value: 'client_admin/menu/item.html'.
    ...
    description = None
    enabled = True
    template = 'client_admin/menu/item.html'
    children = None
    ...
    def init_with_context(self, context):
        ...
        pages::
            ...
            from client_admin.menu.items import MenuItem
...
class AppList(MenuItem, AppListElementMixin):
    ...
    In addition to the parent :class:`~client_admin.menu.items.MenuItem`
    ...
    def is_empty(self):
        ...
        >>> from client_admin.menu.items import MenuItem, AppList
...
class ModelList(MenuItem, AppListElementMixin):
    ...
    def is_empty(self):
        ...
        >>> from client_admin.menu.items import MenuItem, ModelList
